...
const PERMISSION_SECTIONS: PermissionSection[] = [
  ...
  { key: 'edu-students', label: '등록학생관리',     description: '학점은행제 등록학생 목록 (담당: 본인 학생만, 대리 이상: 전체)', allowOwn: true, group: '교육운영' },
  ...
  { key: 'me-leave',   label: '내 휴가현황',          description: '개인 휴가 잔여 + 빠른 신청 페이지 (사이드바 노출 여부)', allowOwn: false, group: '시스템' },
  { key: 'calendar',   label: '개인 캘린더',          description: '개인 캘린더 (사이드바 노출 여부)', allowOwn: false, group: '시스템' },
