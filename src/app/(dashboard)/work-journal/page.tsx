...
function ConsultationList({
  ...
  const toggleOption = (key: string, opt: string) =>
    setDetailSel((p) => {
      ...
      return {
        ...p,
        [key]: cur.includes(opt) ? cur.filter((o) => o !== opt) : [...cur, opt],
      };
    });
                ...
                return (
                  ...
                  >
                    <span className={styles.wcDetailBtnText}>
                      {has
                        ? sel.map((s) => detailOptionLabel(f.key, s)).join(", ")
                        : f.label}
                    </span>
        ...
        >
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M14.3702 3.4064C14.5577 3.59393 14.663 3.84824 14.663 4.1134C14.663 4.37857 14.5577 4.63287 14.3702 4.8204L6.87487 12.3157C6.77582 12.4148 6.65822 12.4934 6.52879 12.547C6.39936 12.6006 6.26063 12.6282 6.12054 12.6282C5.98044 12.6282 5.84171 12.6006 5.71228 12.547C5.58285 12.4934 5.46526 12.4148 5.3662 12.3157L1.6422 8.5924C1.54669 8.50015 1.47051 8.38981 1.4181 8.26781C1.36569 8.1458 1.33811 8.01458 1.33695 7.8818C1.3358 7.74902 1.3611 7.61734 1.41138 7.49445C1.46166 7.37155 1.53591 7.2599 1.62981 7.16601C1.7237 7.07211 1.83535 6.99786 1.95825 6.94758C2.08114 6.8973 2.21282 6.872 2.3456 6.87315C2.47838 6.8743 2.6096 6.90189 2.73161 6.9543C2.85361 7.00671 2.96396 7.08289 3.0562 7.1784L6.1202 10.2424L12.9555 3.4064C13.0484 3.31347 13.1587 3.23976 13.28 3.18946C13.4014 3.13917 13.5315 3.11328 13.6629 3.11328C13.7942 3.11328 13.9243 3.13917 14.0457 3.18946C14.1671 3.23976 14.2773 3.31347 14.3702 3.4064Z"
              fill="rgb(86, 86, 86)"
            />
          </svg>
        </button>
  ...
  return (
    <div className={styles.app}>
      <div className={styles.container}>
        ...
        <div
          className={`${styles.topRow} ${isSales ? styles.topRowHidden : ""}`}
        >
          {isDefault ? (
