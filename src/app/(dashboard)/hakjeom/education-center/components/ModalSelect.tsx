...
export default function ModalSelect({ value, onChange, options, placeholder, disabled }: Props) {
  ...
  return (
    <div className={styles.wrap} ref={ref}>
      <button
        type="button"
        disabled={disabled}
        className={`${styles.trigger} ${open ? styles.trigger_open : ''} ${hasValue ? styles.trigger_active : ''}`}
