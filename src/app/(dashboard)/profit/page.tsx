...
function IconProfit() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path fillRule="evenodd" clipRule="evenodd" d="M12 2C17.523 2 22 6.477 22 12C22 17.523 17.523 22 12 22C6.477 22 2 17.523 2 12C2 6.477 6.477 2 12 2ZM12 4C9.87827 4 7.84344 4.84285 6.34315 6.34315C4.84285 7.84344 4 9.87827 4 12C4 14.1217 4.84285 16.1566 6.34315 17.6569C7.84344 19.1571 9.87827 20 12 20C14.1217 20 16.1566 19.1571 17.6569 17.6569C19.1571 16.1566 20 14.1217 20 12C20 9.87827 19.1571 7.84344 17.6569 6.34315C16.1566 4.84285 14.1217 4 12 4ZM10.586 7.757C10.94 7.40319 11.4139 7.195 11.9139 7.17352C12.414 7.15205 12.9039 7.31885 13.287 7.641L13.414 7.757L16.243 10.586C16.5968 10.94 16.805 11.4139 16.8265 11.9139C16.848 12.414 16.6811 12.9039 16.359 13.287L16.243 13.414L13.414 16.243C13.06 16.5968 12.5861 16.805 12.0861 16.8265C11.586 16.848 11.0961 16.6811 10.713 16.359L10.586 16.243L7.757 13.414C7.40319 13.06 7.195 12.5861 7.17352 12.0861C7.15205 11.586 7.31885 11.0961 7.641 10.713L7.757 10.586L10.586 7.757ZM12 9.172L9.172 12L12 14.828L14.828 12L12 9.172Z" fill="#8D99A5"/>
    </svg>
  )
}
...
function IconPlus() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
      ...
      <path d="M7 14C7 8.53266 7 5.46734 7 2.38419e-07" stroke="#7A8086" strokeWidth="2"/>
    </svg>
  )
}
...
export default function ProfitPage() {
  ...
  // 최근 6개월 영업이익 추이 — 선택월은 현재 입력 중인 지출 반영
  const trendData = monthly.map((m, i) => ({
    month: `${parseInt(m.month.slice(5), 10)}월`,
    profit: i === monthly.length - 1 ? profit : m.profit,
  }))
        ...
        <div className={styles.kpiBand}>
          <div className={styles.kpiCard}>
            ...
            <p className={styles.kpiCompare}>
              전월대비 <span className={styles.kpiCompareValue}>{profitDiff}</span>
            </p>
          </div>

          <svg className={styles.kpiDivider} width="1" height="40" viewBox="0 0 1 40" fill="none">
          ...
          <div className={styles.kpiCard}>
            ...
            <p className={styles.kpiCompare}>
              전월대비 <span className={styles.kpiCompareValue}>{profitRateDiff}</span>
            </p>
          </div>
          ...
          <div className={styles.kpiCard}>
            ...
            <div className={styles.kpiTargetBottom}>
              <div className={styles.kpiTargetMeta}>
                <p className={styles.kpiCompare}>
                  전월대비 <span className={styles.kpiCompareValue}>{targetRateDiff}</span>
                </p>
                <p className={styles.kpiCompare}>
                  목표까지 <span className={styles.kpiCompareValue}>{formatWon(targetRemain)}원</span>
                </p>
              </div>
              <div className={styles.kpiProgressTrack}>
                <div
                  className={styles.kpiProgressFill}
                  style={{ width: mounted ? `${Math.min(targetRate, 100)}%` : '0%' }}
                />
              </div>
            </div>
          </div>
        ...
        <div className={styles.bodyRow}>
          ...
          <div className={styles.rightCol}>
            ...
            <div className={styles.chartCard}>
              <p className={styles.chartTitle}>최근 6개월 영업이익 추이</p>
              <div className={styles.chartBody}>
                <span className={styles.chartUnit}>(단위:원)</span>
                <div className={styles.chartPlot}>
                  <Area
                    ...
                    point={{
                      sizeField: 4.5,
                      style: { fill: '#0084FE', stroke: '#FFF', lineWidth: 1.5 },
                    }}
                    axis={{
                      y: {
