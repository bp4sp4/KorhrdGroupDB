    ...
    <GuideProvider>
      ...
      <div className={styles.dashboardWrap}>
        ...
        <div className={styles.contentColumn}>
          ...
          <main
            className={`${styles.mainContent}${pathname.startsWith('/approvals') ? ` ${styles.mainContentWhite}` : ''}${pathname.startsWith('/profit') || pathname.startsWith('/practice-applicants/agency') || pathname.startsWith('/admin/contracts/') || pathname.startsWith('/me/contracts/') ? ` ${styles.mainContentFlush}` : ''}`}
            style={
